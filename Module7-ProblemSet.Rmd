...
###(f) Next, fit a new linear regression model (mod2) to predict the to predict the danceability of a song with mode as the only predictor, again based on the training data.
